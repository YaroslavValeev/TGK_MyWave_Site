#!/usr/bin/env python3
"""S5 — canonical travel buffer smoke (120 min). HTTP via curl only."""
...
PHONE_B = os.environ.get("S5_PHONE_GYM", "+79990005001")
PHONE_A = os.environ.get("S5_PHONE_BOAT", "+79990005002")
