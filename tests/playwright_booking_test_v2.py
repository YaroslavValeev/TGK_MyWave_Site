...
def main():
    ...
    with sync_playwright() as p:
        ...
        if not btn:
            ...
            has_listener = page.evaluate(f"() => {{ const el = document.querySelector('{selector}'); return !!el._clickListener; }}")
            ...
            listeners_count = page.evaluate(f"() => {{ const el = document.querySelector('{selector}'); return el.getEventListeners ? el.getEventListeners('click').length : 'getEventListeners not available'; }}")
