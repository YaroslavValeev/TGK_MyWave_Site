...
def test_calc_history_filters_by_phone(client, mocker):
    ...
    fake_records = [
        {"ts": "t1", "phone": "+79990001122", "city": "Moscow", "tags": "a", "inputs": "{}", "result": "{}"},
        {"ts": "t2", "phone": "+70000000000", "city": "SPb", "tags": "b", "inputs": "{}", "result": "{}"}
    ]
    mocker.patch('app.services.google_sheets_service.read_records', return_value=fake_records)
