...
def test_register_and_call_tool_with_api_key(client, app):
    ...
    r = client.post('/api/ai/gateway/tools/register_test', json={'name': 'echo2'}, headers=headers)
    ...
    r2 = client.post('/api/ai/gateway/message', json={'message': payload}, headers=headers)
