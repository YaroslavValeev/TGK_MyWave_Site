...
class TestYooKassaPaymentProcessor:
    ...
    def test_processor_initialization_with_credentials(self):
        ...
        processor = YooKassaPaymentProcessor(
            shop_id="test_shop_123", api_key="test_key_456"
        )
    ...
    def test_create_payment(self):
        ...
        assert (
            "confirmation_url" in payment and "yookassa" in payment["confirmation_url"]
        )
...
class TestPaymentWebhooks:
    ...
    def test_verify_webhook_signature(self):
        ...
        payload = {"event": "payment.succeeded", "object": {"id": "payment_123"}}
    ...
    def test_handle_payment_webhook_success(self):
        ...
        payload = {
            ...
            "object": {"id": "payment_123", "status": "succeeded", "amount": 1500.00},
        }
    ...
    def test_handle_payment_webhook_refund(self):
        ...
        payload = {
            ...
            "object": {"id": "payment_456", "refund_id": "refund_789"},
        }
    ...
    def test_handle_payment_webhook_unknown(self):
        ...
        payload = {"event": "unknown.event", "object": {"id": "unknown_123"}}
...
class TestPaymentAPI:
    ...
    def test_refund_payment_endpoint(self, app):
        ...
        with app.test_client() as client:
            response = client.post(
                "/api/payments/refund",
                json={"payment_id": "payment_to_refund", "amount": 1000.00},
            )
    ...
    def test_refund_payment_endpoint_missing_payment_id(self, app):
        ...
        with app.test_client() as client:
            response = client.post("/api/payments/refund", json={"amount": 500.00})
    ...
    def test_webhook_endpoint(self, app):
        ...
        with app.test_client() as client:
            response = client.post(
                ...
                json={
                    "event": "payment.succeeded",
                    "object": {"id": "payment_webhook_test", "status": "succeeded"},
                },
