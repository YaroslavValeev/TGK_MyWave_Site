...
def check_canonical_url():
    ...
    with app.app_context():
        ...
        if server_name:
            ...
            print(
                f"   [WARN] Внимание: если SERVER_NAME != 'mywavetreaning.ru', canonical_url может быть неправильным"
            )
        else:
        ...
        edge_cases = [
            ...
            (
                "/blog/test",
                "https://mywavetreaning.ru/blog/blog/test",
            ),  # Slug с префиксом
            (
                "test-slug/",
                "https://mywavetreaning.ru/blog/test-slug",
            ),  # Slug с trailing slash
        ]
        ...
        for slug, expected_result in edge_cases:
            ...
            if expected_result is None:
                ...
                if canonical == expected_result:
                    ...
                    print(
                        f"   [ERROR] '{slug}' -> {canonical} (ожидается {expected_result})"
                    )
                    all_ok = False
