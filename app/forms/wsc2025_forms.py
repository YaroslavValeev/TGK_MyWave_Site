...
class ParticipantRegistrationForm(FlaskForm):
    ...
    birth_year = IntegerField(
        ...
        validators=[
            ...
            NumberRange(
                min=1930, max=2016, message="Год рождения должен быть от 1930 до 2016"
            ),
        ],
    ...
    city = StringField(
        ...
        validators=[
            ...
            Length(
                min=2, max=50, message="Название города должно быть от 2 до 50 символов"
            ),
        ],
        default="Москва",
...
class CoachRegistrationForm(FlaskForm):
    ...
    club = StringField(
        ...
        validators=[
            Optional(),
            Length(
                max=100, message="Название клуба/школы не должно превышать 100 символов"
            ),
        ],
    ...
    def validate_phone(self, field):
        ...
        if check_duplicate_phone(
            field.data,
            current_app.config.get("WSC2025_COACHES_SHEET", "WSC2025_Coaches"),
        ):
