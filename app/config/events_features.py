...
def is_events_public_ui_flag_set() -> bool:
    """Raw flag without API dependency (for tests / diagnostics)."""
    return _env_flag("EVENTS_PUBLIC_UI_ENABLED")
...
def get_events_feature_flags() -> Dict[str, bool]:
    return {
        ...
        "EVENTS_PUBLIC_UI_ENABLED": is_events_public_ui_enabled(),
        "EVENTS_PUBLIC_UI_FLAG_SET": is_events_public_ui_flag_set(),
    }
