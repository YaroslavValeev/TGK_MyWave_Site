    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            image = Image(
                ...
                size=os.path.getsize(os.path.join(current_app.root_path, 'static', 'uploads', 'images', filename)),
                width=width,
                height=height,
...
def delete(id):
    ...
    try:
        # Удаляем файл
        filepath = os.path.join(current_app.root_path, 'static', 'uploads', 'images', image.filename)
