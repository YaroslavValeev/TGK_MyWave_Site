...
from app.config.cache_config import ALLOWED_IMAGE_EXTENSIONS, IMAGE_CACHE_CONFIG
...
def get_best_format(accept_header):
    ...
    formats = {"image/webp": "webp", "image/jpeg": "jpeg", "image/png": "png"}
...
def serve_image(filename):
    ...
    try:
        ...
        # Добавляем заголовки
        response.headers["Cache-Control"] = IMAGE_CACHE_CONFIG.get(
        ...
        response.headers["X-Image-Original-Size"] = (
