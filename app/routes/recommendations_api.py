...
from app.services.recommendations_service import recommend, get_cache_stats, reset_cache_stats
...
def get_recommendations():
    ...
    items = recommend(context=context, user_key=user_key, city=city, slug=slug, limit=limit)
    if not items:
        return ('', 204)
