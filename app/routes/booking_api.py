...
def booking_entry():
    ...
    try:
        ...
        current_app.logger.info(
            f"[booking] reply='{reply_text}' state_out={updated_state}"
        )
    ...
    try:
        ...
        try:
            ...
            current_app.logger.debug(
                "Failed to log Safari booking analytics on create", exc_info=True
            )
    ...
    try:
        ...
        if request.method == "GET":
            ...
            try:
                ...
                current_app.logger.debug(
                    "Failed to log Safari booking analytics on get", exc_info=True
                )
        ...
        try:
            ...
            current_app.logger.debug(
                "Failed to log Safari booking analytics on patch", exc_info=True
            )
