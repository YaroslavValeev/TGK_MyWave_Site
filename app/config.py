...
def find_service_account_file():
    possible_paths = [
        ...
        str(
            Path(__file__).resolve().parent.parent / "instance" / "service_account.json"
...
GOOGLE_SHEETS_FILE_NAME = os.getenv(
    "GOOGLE_SHEETS_FILE_NAME", "MyWave_Admin_Tg_Bot - Clients (1)"
)
