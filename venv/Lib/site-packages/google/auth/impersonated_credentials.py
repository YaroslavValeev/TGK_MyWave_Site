...
class Credentials(
    ...
    .. _Service Account Token Creator:
        https://cloud.google.com/iam/docs/service_accounts#the_service_account_token_creator_role

    .. _Creating Short-Lived Service Account Credentials:
        https://cloud.google.com/iam/docs/creating-short-lived-service_account-credentials
